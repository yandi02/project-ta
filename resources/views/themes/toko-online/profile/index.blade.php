...
@section('breadcrumb')
    @parent
    <div class="breadcrumb-item active" aria-current="page"><a href="{{ route('profile_user.index') }}">Profile</a></div>
    <div class="breadcrumb-item active" aria-current="page">{{ auth()->user()->name }}</div>
@endsection
        ...
        <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h2 class="fw-semibold mb-8">Pengaturan Akun</h2>
                    </div>
                    <div class="col-3">
                        <div class="text-center">
                            <img width="100" src="{{ asset('modernize2/images/account-settings.svg') }}"
                ...
                <div class="col-lg-6 d-flex align-items-stretch">
                    <div class="card w-100 border position-relative overflow-hidden">
                        <div class="card-body p-4">
                            ...
                            <div>
                                <label for="exampleInputPassword3" class="form-label">Konfirmasi Password Baru</label>
