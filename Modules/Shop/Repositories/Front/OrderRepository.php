...
class OrderRepository implements OrderRepositoryInterface
{
    ...
    private function generatePaymentUrl($order)
    {
        ...
        $params = [
            'enable_payments' => \Modules\Shop\App\Models\Payment::PAYMENT_CHANNELS,
            'transaction_details' => [
                'order_id' => $order->id,
            ...
            'expiry' => [
                ...
                'unit' => \Modules\Shop\App\Models\Payment::EXPIRY_UNIT,
                'duration' => \Modules\Shop\App\Models\Payment::EXPIRY_DURATION,
            ]
        ];
